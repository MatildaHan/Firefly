...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		// 桌面背景图片（支持单张或多张随机）
		// desktop: "assets/images/DesktopWallpaper/banner1.jpg",
		desktop: [
			"assets/images/DesktopWallpaper/banner1.jpg",
			"assets/images/DesktopWallpaper/banner2.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/DesktopWallpaper/banner1.jpg",
		mobile: [
			"assets/images/DesktopWallpaper/banner1.jpg",
			"assets/images/DesktopWallpaper/banner2.jpg",
		],
